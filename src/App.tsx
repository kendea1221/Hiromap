      ...
      if (targetSpot && logText.trim()) {
        ...
        setMessages((prev) => [
          ...prev,
          {
            id: crypto.randomUUID(),
            role: "ai",
            text: `${commentTargetName}にコメントを追加しました。`,
          },
        ]);
      }
      ...
      <main className="relative pt-14 h-[calc(100vh-56px)]">
        ...
        >
          ...
          {userLocation && (
            ...
            >
              <Popup>
                <div className="text-sm font-medium">現在地</div>
              </Popup>
            </Marker>
          )}
